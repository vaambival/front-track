        ...
        <div class="search-bar">
            <table class="search-fields" v-on:click="activeClear">
                    <tr>
                        <td>
                            <p>Название</p>
                            <input type="text" v-model="nameProblem"/>
                        </td>
                        <td>
                            <p>Автор</p>
        ...
        methods: {
            ...
            searchPromlemsByParams(){
                this.$http.get(PROBLEM_URL_WITHOUT_PREFIX + '?' + (this.nameProblem == "" ? "" : ('name='+this.nameProblem))
                    ...
                    + (this.sourceType.default == null ? "" : ('&sources=' + this.sourceType.default.map(u => u.sourceTypeCode).join(',')))
                    + (this.status.default == null ? "" : ('&statuses=' + this.status.default.map(u => u.statusCode).join(',')))
                    + (this.stage.default == null ? "" : ('&stages=' + this.stage.default.map(u => u.stageCode).join(',')))
